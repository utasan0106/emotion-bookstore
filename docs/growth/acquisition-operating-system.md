...
Proposed copy for review: 「2015年に撮られた庚申通りには、街路灯と店先の看板が続いています。通りの名をたどると、商店街が紹介する1716年建立の庚申塔へ。高円寺を歩くとき、いつもの道の名前を読み直してみませんか。」 Attach the capture year, [Mapillary source image](https://www.mapillary.com/app/?pKey=538363923973908), scene ID, snapshot `2026-09-13-r1`, `© Mapillary contributors (CC BY-SA 4.0) を加工 / みちよみ`, and the [商店街の解説](https://koushindoori.com/about/mame1). Link to an existing Koenji cultural destination only after checking that the route and editorial relation are truthful. The wording is an editorial draft, not an approved public fact card.
