...
- Three voluntary context disclosures, one official video, explicit stop, official film/park exits. No accounts, maps, storage, telemetry, video extraction or new player API.
