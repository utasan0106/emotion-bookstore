...
(() => {
  const cities = {
    ...
    jinbocho: { name:'神保町', image:'assets/city-jinbocho.jpg', alt:'神保町の古書店', place:'古書店のある通り', kind:'本', title:'森崎書店の日々', hook:'古書店で過ごす時間から、人との出会いへ。', relation:'神保町の風景から、古書店街を舞台にした小説へ。写真の書店が作中の書店という意味ではありません。', path:'jinbocho/morisaki.html', line:'本を開くと、街の見え方も変わりそうです。' }
  };
  ...
  function selectCity(id) {
    ...
    $('mana-line').textContent = city.line;
  ...
  $('reset').addEventListener('click', () => {
    ...
    $('mana-line').textContent = 'どの街を、のぞいてみますか。';
