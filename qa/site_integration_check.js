...
for(const item of items) {
 ...
 if(item.presentation==='text-only') {
  ...
  assert.ok(['koenji/jirokichi','kichijoji/honnoniwa','koenji/shiroku-somaru','koenji/1q84','kichijoji/gou-gou-book','jinbocho/morisaki','jinbocho/morisaki-sequel','jinbocho/furuhon','jinbocho/furuhon-sequel','shimokitazawa/lady-jane','shimokitazawa/honda','kichijoji/cinema-history','koenji/junjo'].includes(item.city+'/'+item.id));
