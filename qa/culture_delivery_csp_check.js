...
for (const url of [...special, ...ordinary]) {
  ...
  assert.deepEqual(directive(policies[0], 'frame-src'),
    [special.includes(url) ? 'https://bandcamp.com' : 'https://www.youtube-nocookie.com'], url);
...
console.log('PASS: ' + (special.length + ordinary.length) + ' route cases; scoped Bandcamp and common privacy headers.');
