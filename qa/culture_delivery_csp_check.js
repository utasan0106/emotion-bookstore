...
const ordinary = ['/', '/index.html', '/works.html', '/work-music.html', '/thread.html', '/shelf.html',
...
for (const url of [...special, ...ordinary, ...social]) {
  ...
  assert.deepEqual(directive(policies[0], 'frame-src'),
    special.includes(url) ? ['https://bandcamp.com'] : ['/', '/index.html', '/works.html', '/work-music.html'].includes(url) ? ['https://www.youtube-nocookie.com', 'https://bandcamp.com'] : social.includes(url) ? ['https://www.youtube-nocookie.com', 'https://embed.bsky.app', 'https://www.instagram.com'] : ['https://www.youtube-nocookie.com'], url);
