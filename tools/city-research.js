...
module.exports = [{
  ...
  methodology:'広告主・施設運営者・自治体の公開資料と、武蔵野市開発公社の来街者調査概要を基にした読み解き記事です。調査はWi-Fi利用端末が対象で、全来街者を代表するものではありません。広告による来街への効果や世代差は検証の対象外です。',
  summary: [
    '吉祥寺の広告には、商品だけでなく、街での過ごし方を提案する企画がある。',
    '2024年の来街者調査概要では、平日は仕事・学校、週末は買い物・飲食の目的が多い。',
    'ただし調査はWi-Fi利用端末が対象。街全体の傾向や、広告の効果までは言えない。'
  ],
