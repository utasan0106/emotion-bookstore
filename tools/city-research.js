...
module.exports = [{
  ...
  sections:[
    {title:'変わったのは、買い物先だけ？',kind:'感情書店の読み解き',text:'新しい店の名前を覚えるだけでなく、以前は通れなかった場所を歩く、広場で待つ、映画の帰りに立ち寄る、と考えてみる。線路跡という一本の場所から、街の楽しみ方を見直せる。ただし、ここに挙げた過ごし方は編集上の提案で、利用者を観察した調査結果ではない。'},
    ...
    {title:'「昔のほうがよかった」は、まだ結論にしない',kind:'次に確かめたいこと',text:'この5資料には、以前から通う人や店を営む人への独自取材がない。家賃の変化、閉店の理由、年代別の来街目的も検証していない。開発側の説明だけで成功と決めず、逆に新しい建物だけを見て文化が失われたとも決めない。次回は、時期の分かる公開記録と、掲載同意を得た声を照合したい。'}
  ]
}];
