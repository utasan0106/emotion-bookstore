...
// The licensed photograph is stored locally so the observation can be seen on the page.
function koenjiStreetFragment() {
  return `<section class="street-fragment" aria-labelledby="street-fragment-title"><figure class="street-fragment-photo"><img src="/assets/koenji-koshin-2015-mapillary.jpg" alt="2015年の高円寺庚申通り。商店街の看板と通りの店先、歩く人が写る" width="1024" height="768" loading="lazy" decoding="async"><figcaption><span>2015年撮影 · 写真 © Mapillary contributors</span><a class="street-fragment-mapillary" href="https://www.mapillary.com/?locale=ja_JP" target="_blank" rel="noopener noreferrer"><img src="/assets/mapillary-logo.svg" alt="" width="26" height="26" loading="lazy" decoding="async">Mapillary</a><a href="/data.html#koenji-street-photo">写真とデータの扱い</a></figcaption></figure><div class="street-fragment-main"><p class="eyebrow">街の断片 · 2015年の記録</p><h2 id="street-fragment-title">庚申通りの名前をたどる</h2><p>2015年の写真に写る庚申通り。商店街が伝えるその名の背景には、1716年に建てられた庚申塔があります。高円寺には、小説の題名から愛称が生まれた別の「純情商店街」も。二つの名前から、この街と一冊の本をたどってみませんか。</p><a class="street-fragment-action" href="/discover/koenji/junjo.html">ねじめ正一『高円寺純情商店街』を見る →</a></div></section>`;
}
