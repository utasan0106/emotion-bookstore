'use strict';
// Human-checked identity and primary sources. No runtime lookup or guessed biographies.
...
module.exports = {
  ...
  'womenslib-interview': {name:'仲野太賀', text:'俳優。映画『すばらしき世界』『あの頃。』、ドラマ『コントが始まる』『虎に翼』などに出演。', url:'https://www.stardust.co.jp/talent/section1/nakanotaiga/', checkedAt:'2026-09-09'}
};
